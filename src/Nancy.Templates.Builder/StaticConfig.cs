    ...
    public static class StaticConfig
    {
        ...
        public static readonly TemplateConfig[] TemplateConfigProjects =
        {
            ...
            new TemplateConfig
            {
                ProjectFileName =
                    RootPath +
                    @"Nancy.Templates.CSharp.SelfHostWithRazor\Nancy.Templates.CSharp.SelfHostWithRazor.csproj",
            ...
            {
                ProjectFileName =
                    RootPath + @"Nancy.Templates.CSharp.EmptyAspNetHost\Nancy.Templates.CSharp.EmptyAspNetHost.csproj",
            ...
            new TemplateConfig
            {
                ProjectFileName =
                    RootPath +
                    @"Nancy.Templates.CSharp.EmptyAspNetHostingWithRazor\Nancy.Templates.CSharp.EmptyAspNetHostWithRazor.csproj",
                Name = "Nancy Empty Application with ASP.NET hosting and Razor",
                Description =
                    "An empty project for creating a Nancy application with Razor support that is hosted on ASP.NET",
                ProjectType = "CSharp"
            },
            new TemplateConfig
            {
                ProjectFileName =
                    RootPath + @"Nancy.Templates.CSharp.EmptySelfHost\Nancy.Templates.CSharp.EmptySelfHost.csproj",
            ...
            new TemplateConfig
            {
                ProjectFileName =
                    RootPath +
                    @"Nancy.Templates.CSharp.EmptySelfHostWithRazor\Nancy.Templates.CSharp.EmptySelfHostWithRazor.csproj",
